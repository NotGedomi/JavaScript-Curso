...
class Persona {
    // Atributo estatico / Con Static, el atributo se asocia a la clase, mas no a ningun objeto
    static contadorObjetosPersona = 0;

    // Atributo no estatico / Sin Static, el atributo se asocia a los objetos
    email = 'Valor Default'; 
